...
class ReleasePolicyTests(unittest.TestCase):
    def test_candidate_identity_and_certificate_are_preserved(self):
        ...
        self.assertEqual((compatibility["version"], compatibility["stage"]), ("9.0.0", "public-release"))
        self.assertIn("HOME_TUNNEL_VERSION_NAME=9.0.0\n", properties)
        self.assertIn("HOME_TUNNEL_VERSION_CODE=9000000\n", properties)
